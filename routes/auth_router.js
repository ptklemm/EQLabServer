...
const auth_router = require("express").Router(),
    User = require(__serverRoot + '/models/sequelize/user.js'),
...
{
    console.log("EQLab: Registering New User: " + req.body.user.username);
...
auth_router.post('/login', jsonParser, (req, res, next) =>
{
    User.authenticate()(req.body.user.username, req.body.user.password, (err, user, authError) =>
    {
        ...
        {
            console.log("EQLab: Logging in User: " + req.body.user.username);
            jwt.sign(
            {
                user:
                {
